...
require (
	...
	github.com/confidentsecurity/twoway v0.0.14
	...
	github.com/openpcc/openpcc v0.0.14
...
require (
	github.com/confidentsecurity/bhttp v0.0.14 // indirect
	github.com/confidentsecurity/ohttp v0.0.14 // indirect
)
